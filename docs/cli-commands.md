...
- **edit** - Edit an existing cluster (including role: other, prod, or dr).
...
Adds a Kafka cluster (name, provider, brokers, and role: other, prod, or dr).
...
**Edit an existing cluster (including role: other, prod, or dr).**
...
- **disable** - Turn the kill-switch off (admin)
- **enable** - Turn the kill-switch on (admin)
- **halt** - Pause every running job (admin)
- **resume** - Clear a CLI/API halt. Does not restart jobs.
- **status** - Show whether halt is enabled or active

#### mirror-cli protection disable

**Turn the kill-switch off (admin)**
...
#### mirror-cli protection halt

**Pause every running job (admin)**

### Usage

```
mirror-cli protection halt [reason]
```

#### mirror-cli protection resume

**Clear a CLI/API halt. Does not restart jobs.**
...
**Show whether halt is enabled or active**
